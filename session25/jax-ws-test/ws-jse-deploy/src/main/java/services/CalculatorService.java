 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:9999/calc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9999/calc?wsdl");
